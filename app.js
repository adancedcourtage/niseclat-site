document.addEventListener("DOMContentLoaded", () => {
  ...
  const ritualSteps = [
    { id: "cleanse", image: "assets/images/savon-chevre.png", title: { fr: "Nettoyer", en: "Cleanse", ar: "تنظيف" }, text: { fr: "Retirer les impuretés sans décaper la barrière cutanée.", en: "Remove impurities without stripping the skin barrier.", ar: "إزالة الشوائب بدون قسوة على حاجز البشرة." }, product: products[2] },
    ...
    { id: "protect", image: "assets/images/packs-niseclat.png", title: { fr: "Protéger", en: "Protect", ar: "حماية" }, text: { fr: "Sceller l’éclat avec une protection naturelle adaptée.", en: "Seal glow with suitable natural protection.", ar: "تثبيت الإشراقة بحماية طبيعية مناسبة." }, product: products[3] },
  ];
  const articles = [
